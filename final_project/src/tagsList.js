export const tagsList = {
  ...
  treatment: [
    ...
    { value: "1", label: "טיפול פעם בשבוע" },
    { value: "2", label: "טיפול פעם בשבועיים" },
    { value: "3", label: "טיפול מינימלי" },
  ],
  light: [
  ...
  flowers: [
    { value: "0", label: "צמח פרחוני" },
    { value: "1", label: "צמח ללא פרחים" },
    { value: "2", label: "צמח עם פרחים בודדים" },
  ],
  size: [
  ...
  experience: [
    { value: "0", label: "זהו הצמח הראשון שלי" },
    { value: "1", label: "גידלתי צמח/ שניים" },
    { value: "2", label: "אני מגדל צמחים מנוסה" },
